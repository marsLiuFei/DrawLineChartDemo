...
@interface LF_drawMonthLineChart()<CAAnimationDelegate>

@property (nonatomic, strong) UIScrollView *gradientBackgroundView;//展示折线的背景
@end

static CGFloat bounceX = 20;
static CGFloat bounceY = 40;

@implementation LF_drawMonthLineChart
